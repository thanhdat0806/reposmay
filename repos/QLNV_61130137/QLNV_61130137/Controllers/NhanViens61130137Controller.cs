...
using QLNV_61130137.Models;

namespace QLNV_61130137.Controllers
{
    public class NhanViens61130137Controller : Controller
    {
        private QLNV_61130137Entities db = new QLNV_61130137Entities();

        // GET: NhanViens61130137
        ...
        [HttpPost]
        public ActionResult TimKiem_61130137(string maNV)
        {
        ...
        public ActionResult TimKiemNC_61130137(string maNV = "", string hoTen = "", string gioiTinh = "", string luongMin = "", string luongMax = "", string diaChi = "", string maPB = "")
        {
        ...
        // GET: NhanViens61130137/Details/5
        ...
        // GET: NhanViens61130137/Delete/5
        ...
        // POST: NhanViens61130137/Delete/5
