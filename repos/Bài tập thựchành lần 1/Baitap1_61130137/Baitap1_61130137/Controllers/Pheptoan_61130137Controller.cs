...
namespace Baitap1_61130137.Controllers
{
    public class Pheptoan_61130137Controller : Controller
    {
        // GET: Pheptoan_61130137
        ...
        [HttpPost]
        public ActionResult Indexmodel(PT cal)
        {
            switch (cal.pt)
            {
